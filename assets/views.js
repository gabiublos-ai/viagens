...
(function () {
  ...
  function ajustesView() {
    ...
    html += '<div class="card"><div class="card-head"><h2>Backup e exportação</h2></div>' +
      ...
      "</div>" +
      '<div class="row"><span class="t-sub">Última alteração: ' +
      esc(new Date(C.db.atualizadoEm || Date.now()).toLocaleString("pt-BR")) + "</span></div>" +
      ...
      '<span class="t-sub">Descarta tudo que foi lançado aqui.</span></div>' +
      "</div></div>";
